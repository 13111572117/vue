<template>
  <div class="layui-tab layui-tab-brief" lay-filter="docDemoTabBrief">
      <ul class="layui-tab-title">
          <li class=""><i class="layui-icon layui-icon-form"></i>文章</li>
          <li class="layui-this"><i class="layui-icon layui-icon-notice"></i>动态</li>
          <li class=""><i class="layui-icon layui-icon-dialogue"></i>最新评论</li>
      ...
      <div class="layui-tab-content" style="height: 100px;">
          ...
          <div class="layui-tab-item layui-show">
            ...
            <div id="zxj-aj">
              ...
              <button type="button" class="layui-btn"><span><i class="el-icon-plus"></i>已关注</span></button>
              </div>
            ...
            <div id="zxj-ae" style="width:100%;height:30px;margin-top:20px;">
              ...
              <div style="line-height:25px;">
                <el-row :gutter="20">
                    <el-col :span="18"><div class="grid-content bg-purple" style="">
                        <div id="zxj-ae" style="width:100%;height:30px;margin-top:20px;">
                          <a href=""><img src="../../assets/images/zxj1.jpg" alt=""></a>
                          <a href="">张三8888</a>
                          <span>关注了作者 · 05.29 11:09</span>
                        ...
                        <p style="font-size:13px;color:#999999;">在user.php中增加如下代码用于打开del.html编写的函数为del()；编写的delete()函数是用于删除指定主键值的数据记录； 注意：delete()函数中的$u...</p>
                            <div id="zxj-ag">
                              <a href="">小冕</a>
                              <a href=""><i class="el-icon-view"></i>252</a>
                              <a href=""><i class="el-icon-chat-square"></i>2</a>
                    ...
                    <el-col :span="6"><div class="grid-content bg-purple-light" style="margin-top:20px;">
